...
* - Di chuyển thông tin phiên bản sang góc dưới bên trái
*/
...
const HomePage = () => {
    ...
    return (
        <div className="relative min-h-[70vh] p-4">
            ...
            {/* Thông tin phiên bản - di chuyển sang góc dưới bên trái */}
            <div className="fixed bottom-4 left-4 bg-white dark:bg-gray-800 rounded-lg shadow-md px-4 py-2 border border-gray-200 dark:border-gray-700 opacity-80 hover:opacity-100 transition-opacity">
