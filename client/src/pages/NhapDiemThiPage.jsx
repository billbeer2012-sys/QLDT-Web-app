/*
* D:\QLDT-app\client\src\pages\NhapDiemThiPage.jsx
* Cập nhật: 15/11/2025
* Tóm tắt:
...
import { Loader, AlertCircle, Search, FileDown, Calendar, CalendarClock, UserCog } from 'lucide-react';
...
const ExamSchedulePage = () => {
	...
	usePageLogger('Nhập điểm thi phòng');
    ...
    useEffect(() => {
        ...
        axiosInstance.get('/nhap-diem-thi/semesters')
            .then(res => {
    ...
    const fetchSchedules = useCallback(() => {
        ...
        axiosInstance.get('/nhap-diem-thi/list', { params })
    ...
    return (
        <div className="p-4 sm:p-6 h-full flex flex-col bg-gray-50 dark:bg-gray-900">
            <h1 className="text-2xl font-bold text-blue-800 dark:text-white mb-4 text-center uppercase">
                <UserCog className="inline-block w-8 h-8 mr-2" />
                NHẬP ĐIỂM THI THEO PHÒNG
            </h1>
