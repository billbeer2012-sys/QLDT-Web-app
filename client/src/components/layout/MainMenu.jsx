        ...
        children: [
            {
            ...
            },
			 {
                ...
                children: [
                    { id: 'schedule', title: 'Xem TKB', type: 'tab', componentName: 'SchedulePage', auth: 'public', icon: <BookOpen className="w-5 h-5 mr-3" /> },
					{ id: 'teaching-schedule', title: 'Lịch giảng dạy', type: 'tab', componentName: 'LichGiangDayPage', auth: 'isVC', icon: <Calendar className="w-5 h-5 mr-3" /> },
