/*
* D:\QLDT-app\server\routes\exam-schedule.js
* Cập nhật: 03/08/2025
* Tóm tắt:
* - Cập nhật câu lệnh SQL để cột "Lanthi" trả về giá trị viết tắt (Gk, L1, L2)
* để tối ưu hóa và hỗ trợ cho việc định dạng màu sắc ở frontend.
*/
